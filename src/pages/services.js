  ...
  return (
    ...
    <div id="content">
      ...
      <div className="row mb-5">
                    <div
                        className="col-xxl-3 col-xl-6 col-lg-6 mb-5 border-bottom col-xxl-3 col-xl-6 col-lg-6 mb-5 border-bottom border-warning">
                        <h3>
                    ...
                    <div
                        className="col-xxl-3 col-xl-6 col-lg-6 mb-5 border-bottom col-xxl-3 col-xl-6 col-lg-6 mb-5 border-bottom border-warning">
                        <h3><span className="id-color">RUHSAT</span> PROJELERİ</h3>
                        İnşaat izinlerinin alınması
                        için gerekli Elektrik,
                        Mekanik, Statik ve Mimari
                    ...
                    <div
                        className="col-xxl-3 col-xl-6 col-lg-6 mb-5 border-bottom col-xxl-3 col-xl-6 col-lg-6 mb-5 border-bottom border-warning">
                        <h3><span className="id-color">ÜRETİM</span></h3>
                        Şantiyede kullanılacak
                        prekast duvar panellerinin
                        ve diğer inşaat
                    ...
                    <div
                        className="col-xxl-3 col-xl-6 col-lg-6 mb-5 border-bottom col-xxl-3 col-xl-6 col-lg-6 mb-5 border-bottom border-warning">
                        <h3><span className="id-color">ELEKTRİK VE</span> OTOMASYON</h3>
                        Binaların elektrik
                        sistemleri ve otomatik
                ...
                <div className="row">
                    <div
                        className="col-xxl-3 col-xl-6 col-lg-6 mb-5 border-bottom col-xxl-3 col-xl-6 col-lg-6 mb-5 border-bottom border-warning">
                        <h3><span className="id-color">MEKANİK VE</span> İKLİMLENDİRME</h3>
                        Binanın mekanik tesisat,
                        ısıtma ve klima
                    ...
                    <div
                        className="col-xxl-3 col-xl-6 col-lg-6 mb-5 border-bottom col-xxl-3 col-xl-6 col-lg-6 mb-5 border-bottom border-warning">
                        <h3><span className="id-color">İÇ</span> MİMARİ</h3>
                        İç mekanlarının müşteri
                    ...
                    <div
                        className="col-xxl-3 col-xl-6 col-lg-6 mb-5 border-bottom col-xxl-3 col-xl-6 col-lg-6 mb-5 border-bottom border-warning">
                        <h3><span className="id-color">PEYZAJ</span></h3>
                        Dış mekanların bitki, su
                        ögeleri ve diğer unsurlarla
                        düzenlenmesi.
                        <br/>
                        <br/>
                        <div className="spacer-single"></div>
                    ...
                    <div
                        className="col-xxl-3 col-xl-6 col-lg-6 mb-5 border-bottom col-xxl-3 col-xl-6 col-lg-6 mb-5 border-bottom border-warning">
                        <h3><span className="id-color">GARANTİ</span></h3>
                        İnşaat sonrası
                        hizmetlerde kalite
                        güvencesi ve onarım
                        desteği sağlanması.
