...
const ModelDetails = ({ isOpen, onClose, model }) => {
  ...
  return (
    <div
      ...
      aria-hidden={!isOpen}
      style={{ display: isOpen ? 'block' : 'none', backgroundColor: 'rgba(0, 0, 0, 0.5)' }} // Transparan arka plan
    >
      <div className="modal-dialog modal-fullscreen modal-dialog-scrollable">
        <div className="modal-content">
          <div className="modal-header pb-4">
            <h5 className="modal-title ms-5" id="scrollableModalLabel">{model?.title || 'Model Detayları'}</h5>
            <button type="button" className="btn-close me-5" onClick={onClose} aria-label="Close">
              ...
              <div className="row">
                ...
                <div className="col-md-4">
                  <div className="project-info">
                    <h2>{model?.title || 'Model Başlığı'}</h2><br />
